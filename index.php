                    ...
                    <div class="panel-body">
                        <form method="POST" role="form">
                            <fieldset>
                                ...
                                <button type="submit" name="loginButton" value="true" class="btn btn-success btn-block">Login</button>

		     <a class="btn btn-primary btn-block" href="paginas/cadastro.php"><i class="fa fa-plus"></i>Cadastro</a>
